/*
 ...
 Source Schema         : apotek_db_dev_dev

 Target Server Type    : MySQL
 Target Server Version : 100422
 File Encoding         : 65001

 Date: 31/01/2024 22:44:52
*/
...
CREATE TABLE `tm_status_konsinyasi`  (
  `id_status_konsinyasi` int(255) NOT NULL,
...
-- ----------------------------
-- Table structure for tm_status_op_ed
-- ----------------------------
DROP TABLE IF EXISTS `tm_status_op_ed`;
CREATE TABLE `tm_status_op_ed`  (
  `id_status_op_ed` int(11) NOT NULL AUTO_INCREMENT,
  `nama_status` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  PRIMARY KEY (`id_status_op_ed`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `tx_beli_rencana`  (
  ...
  `jumlah_diterima` int(11) NULL DEFAULT NULL,
...
) ENGINE = InnoDB AUTO_INCREMENT = 7651 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 3008 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 2482 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 1112 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 7455 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `tx_trans_keu`  (
  ...
  `nominal` bigint(25) NULL DEFAULT NULL,
  `ket` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL,
