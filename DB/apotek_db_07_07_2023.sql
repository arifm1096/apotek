...
CREATE TABLE `tm_satus_stok`  (
  ...
  `nama_satus` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
...
INSERT INTO `tx_produk_stok` VALUES (2, 14, 2, 1, NULL, 132, NULL, '2023-07-30', 2, '0000-00-00 00:00:00', NULL, '2023-07-06 10:25:41', NULL, NULL, 0);
...
CREATE TABLE `tx_produk_stok_his`  (
  `id_stok_his` int NOT NULL AUTO_INCREMENT,
